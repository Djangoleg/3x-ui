...
curl -sfLRO "https://github.com/XTLS/Xray-core/releases/download/v26.6.22/Xray-macos-${ARCH}.zip"
unzip "Xray-macos-${ARCH}.zip"
rm -f "Xray-macos-${ARCH}.zip" geoip.dat geosite.dat
mv xray "xray-darwin-${FNAME}"

curl -sfLRO "https://github.com/9seconds/mtg/releases/download/v${MTG_VER}/mtg-${MTG_VER}-darwin-${MTG_ARCH}.tar.gz"
